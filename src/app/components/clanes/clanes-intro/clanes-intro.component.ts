...
export class ClanesIntroComponent implements OnInit{
  ...
  generateVillas() {
    this.listaClanes = [{
      ...
      cualidad: "Los Uchiha eran famosos por tener grandes reservas de un chakra muy fuerte y jutsus formidables y la aptitud natural para todo lo relacionado con el combate. Aún así, su principal habilidad era su admirable y eficaz Sharingan.",
  ...
  },
    {
      ...
      cualidad: "Los Uzumaki eran conocidos por su uso del Fūinjutsu, empleando sellos que se asimilaban al emblema del clan.",
    ...
    },
    {
      ...
      cualidad: "Los Senju, descendían de manera directa del Sabio de los Seis Caminos. Gracias a este linaje, los Senju tenderían a heredar de manera innata el Elemento Yang también. Otro aspecto destacable es que, llegaron a ser excelentes maestros en todas las habilidades Ninjutsu, Taijutsu y Genjutsu, hasta el punto de ser conocido como 'El Clan de las Mil Habilidades'",
    ...
    },
    {
      ...
      cualidad: "Los miembros de este clan se conocen principalmente por que tienen un Jutsu Secreto que les permite manipular sus sombras para sus propios beneficios.",
